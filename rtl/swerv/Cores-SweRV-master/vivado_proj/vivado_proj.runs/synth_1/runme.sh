...
HD_PWD='F:/Cores-SweRV-master/vivado_proj/vivado_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerv_wrapper.tcl
